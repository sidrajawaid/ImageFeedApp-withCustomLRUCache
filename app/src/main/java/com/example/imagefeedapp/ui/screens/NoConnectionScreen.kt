...
fun NoConnectionScreen() {
    ...
    Image(painter = painterResource(R.drawable.no_connectivity),
        contentDescription = "No Connection", modifier = Modifier.padding(8.dp))
    Text(text = "No Connection", modifier = Modifier.padding(8.dp),
        fontFamily = FontFamily.Serif, fontWeight = FontWeight.Bold)
    Text(text="check your connection and try again.", modifier = Modifier.padding(8.dp))
